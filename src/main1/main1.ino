...
void setup()
{
  ...
  StackBlue.begin(115200);            //Se configura velocidad de conexión de StackBlue
  Serial.begin(115200);               //Se configura velocidad de conexión de Arduino-PC
...
void loop()
{
    ...
    if(StackBlue.available())    // Entra en función si el puerto está disponible.
    {
        CadenaAscii[i] = StackBlue.read();

        if(CadenaAscii[i++] == END_OF_MSSG)
        {
